  ...
  return (
    <div className="group relative flex cursor-pointer">
      <motion.img
        ...
        className="rounded-full border-2 border-transparent object-fill w-24 h-24  md:h-28 md:w-28 xl:w-32 xl:h-32 filter group-hover:border-yellow-600  transition duration-300 case-in-out"
      />
